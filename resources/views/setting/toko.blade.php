...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        <li class="breadcrumb-item"><a href="javascript:void(0);"><i data-feather="map-pin"></i></a></li>
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title" id="title-bom">Data Toko</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_toko" id="nama_toko" class="form-control form-control-sm">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="nama_pemilik" id="nama_pemilik" class="form-control form-control-sm">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="alamat" id="alamat" cols="5" rows="5" class="form-control form-control-sm"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            ...
            $('#Modal').modal('show');
            $('#btn-sb').text('Update');
            $('.judul-modal').text('Edit Toko');
            $('#hidden_status').val('edit');
            $('#hidden_id').val($(this).data('id'));
            $('#nama_toko').val($(this).data('nama_toko'));
            $('#nama_pemilik').val($(this).data('nama_pemilik'));
