...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        ...
        <li class="breadcrumb-item"><a href="/adm/paket">Paket</a></li>
        <li class="breadcrumb-item active" aria-current="page"><span>Paket Detail</span></li>
    </ol>
    <h1 class="page-header">Paket Detail</h1>
       
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title" id="title-bom">Data Paket Detail</h4>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#table').DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        $('#Modal').modal('show');
                        $('#btn-sb').text('Tambah');
                        $('.judul-modal').text('Tambah Paket Detail');
        ...
        $(document).on('click', '.edit', function() {
            ...
            $('#Modal').modal('show');
            $('#btn-sb').text('Update');
            $('.judul-modal').text('Edit Paket Detail');
        ...
        $("#add-form").validate({
            ...
            submitHandler: function(form) {
                ...
                if ($('#hidden_status').val() == 'add') {
                    url = '/adm/create_paket_detail';
                } else {
                    url = '/adm/update_paket_detail';
                }
                $.ajax({
                    url: url,
                    type: "POST",
                    ...
                    success: function(data) {
                        if (data.result != true) {
                            Swal.fire({
                                title: 'Gagal',
                                text: "Gagal Tambah / Update Paket Detail",
                                icon: 'error',
                                timer: 3000,
                                showCancelButton: false,
                                showConfirmButton: false,
