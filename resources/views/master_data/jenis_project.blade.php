...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>Jenis Project</span></li>
    </ol>
    <h1 class="page-header">Jenis Project</h1>
       
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title" id="title-bom">Data Jenis Project</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="jenis_project" id="jenis_project" class="form-control form-control-sm">
                                                </div>
                                            </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        ...
        var table = $('#table').DataTable({
            ...
            buttons: [{
                    ...
                    action: function(e, dt, node, config) {
                        ...
                        $('#Modal').modal('show');
                        $('#btn-sb').text('Tambah');
                        $('.judul-modal').text('Tambah Jenis Project');
        ...
        $(document).on('click', '.edit', function() {
            ...
            $('#Modal').modal('show');
            $('#btn-sb').text('Update');
            $('.judul-modal').text('Edit Jenis Project');
            $('#hidden_status').val('edit');
            $('#hidden_id').val($(this).data('id'));
            $('#jenis_project').val($(this).data('jenis_project'));
        });
        ...
        $("#add-form").validate({
            ...
            submitHandler: function(form) {
                ...
                if ($('#hidden_status').val() == 'add') {
                    url = '/adm/create_jenis_project';
                } else {
                    url = '/adm/update_jenis_project';
                }
                $.ajax({
                    url: url,
                    type: "POST",
                    ...
                    success: function(data) {
                        if (data.result != true) {
                            Swal.fire({
                                title: 'Gagal',
                                text: "Gagal Tambah / Update Jenis Project",
                                icon: 'error',
                                timer: 3000,
                                showCancelButton: false,
                                showConfirmButton: false,
