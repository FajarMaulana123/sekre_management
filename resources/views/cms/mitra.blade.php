...
@section('content')
    ...
    <ol class="breadcrumb float-xl-end">
        ...
        <li class="breadcrumb-item active" aria-current="page"><span>Mitra</span></li>
    </ol>
    <h1 class="page-header">Mitra</h1>
       
    <div class="panel panel-inverse">
        <div class="panel-heading">
            <h4 class="panel-title" id="title-bom">Data Mitra</h4>
        ...
        $("#add-form").validate({
            ...
            submitHandler: function(form) {
                ...
                if ($('#hidden_status').val() == 'add') {
                    url = '/adm/create_mitra';
                } else {
                    url = '/adm/update_mitra';
                }
                $.ajax({
                    url: url,
                    type: "POST",
                    ...
                    success: function(data) {
                        if (data.result != true) {
                            Swal.fire({
                                title: 'Gagal',
                                text: "Gagal Tambah / Update Mitra",
                                icon: 'error',
                                timer: 3000,
                                showCancelButton: false,
                                showConfirmButton: false,
